...
- [~] Task: Profile current CSV import and categorization engine performance to establish a baseline.
- [ ] Task: Identify "hot paths" and high-allocation zones in the Zustand store and transaction filtering logic.
